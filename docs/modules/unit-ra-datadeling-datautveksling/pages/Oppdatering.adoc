...
:leveloffset: +1
include::main@unit-ra:unit-ra-datadeling-datautveksling:page$Be om oppdatering  - løsningsmønster i UHF sektoren .adoc[]
include::main@unit-ra:unit-ra-datadeling-datautveksling:page$Håndtere forespørsel om oppdatering  - løsningsmønster UHF .adoc[]
:leveloffset: -1
