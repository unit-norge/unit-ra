...
:leveloffset: +1
include::main@unit-ra:unit-ra-datadeling-datautveksling:page$Delegere rettigheter til databehandler - UHF.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-datautveksling:page$Datautveksling ved oppslag.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-datautveksling:page$Datautveksling ved publisering – konsumering (hendelsesbasert).var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-datautveksling:page$Oppdatering.var.2.adoc[]
:leveloffset: -1
