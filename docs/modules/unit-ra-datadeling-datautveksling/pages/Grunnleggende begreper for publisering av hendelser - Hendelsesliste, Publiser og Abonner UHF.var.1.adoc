...
a| Assosiert med hver hendelse finnes et oppdatert datagrunnlag som tilsvarer tilstanden etter hendelsen inntraff og resultert i en endring i datagrunnlaget.
