...
videre og knyttes til, for eksempel, et domene innenfor datatilbyder sin organisasjon).
...
domenet for å sikre både at begreper og informasjonsmodeller er definert i domenet og for riktig kvalitet, utnytting og sikring av informasjon
i domenet.
