...
trengs for å støtte brukstilfellet under utvikling som prinsipp for god design. I tillegg må tilgang til personopplysninger minimeres i tidsrom, berørte personer og antall opplysninger.
