...
:leveloffset: +1
include::main@unit-ra:unit-ra-datadeling-rutiner:page$Indre API.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-rutiner:page$Ytre API.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-rutiner:page$Notifikasjoner.var.2.adoc[]
:leveloffset: -1
