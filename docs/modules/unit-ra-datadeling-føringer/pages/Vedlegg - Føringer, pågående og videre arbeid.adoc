= Vedlegg - Føringer, pågående og videre arbeid
:wysiwig_editing: 1
...
ut fra behov
* Samle føringer for datatilbydere og -konsumenter, for eksempel
tolkning av arkitekturprinsipper der man blant annet kun skal dele
videre fra en tjeneste data en er autoritativ for
