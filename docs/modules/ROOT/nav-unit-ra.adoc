...
** xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Datadelingsplattformen og fellestjenestene i den.adoc[Datadelingsplattformen og fellestjenestene i den]
