...
:leveloffset: +1
include::main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Føderert API management.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Publisering av hendelser.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Felleskomponenter tilbyr fellestjenester.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Datadeling integrert med IAM.var.2.adoc[]
include::main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Datadeling på tvers av sektorer.var.2.adoc[]
:leveloffset: -1
