...
****
xref:main@unit-ra:unit-ra-datadeling-målarkitekturen:page$Be om oppdatering  - løsningsmønster i UHF sektoren .var.1.adoc[Vis detaljer om elementene i diagrammet] (Tips: kbd:[Shift]-klikk for å åpne i nytt vindu)
****
