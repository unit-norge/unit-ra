...
Meldingsformidleren tar imot notifikasjonen om hendelser fra produsenter, og overfører
notifikasjon til de konsumenter som abonnerer på hendelsestypen, samtidig
