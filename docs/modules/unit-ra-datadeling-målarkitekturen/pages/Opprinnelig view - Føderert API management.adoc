= Opprinnelig view - Føderert API management
:wysiwig_editing: 1
...
.Opprinnelig view - Føderert API management
image::{imagepath}Opprinnelig view - Føderert API management.png[alt=Opprinnelig view - Føderert API management image]



[cols ="1,3", options="header"]
.Elementer i view for Opprinnelig view - Føderert API management
|===
