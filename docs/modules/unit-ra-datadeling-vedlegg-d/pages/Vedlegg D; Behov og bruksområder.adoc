...
Dataforvalteren er ansvarlig for at data opprettholder nødvendig kvalitet, og er samordnet med relaterte datakilder, også når studenen bytter lærested gjennom livet.
