...
* Sikre at UHF følger de Overordnede arkitekturprinsippene for digitalisering av offentlig sektor[https://www.digdir.no/samhandling/overordnede-arkitekturprinsipper/1065]
