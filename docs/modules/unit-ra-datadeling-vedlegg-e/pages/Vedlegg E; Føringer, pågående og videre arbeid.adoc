...
ut fra behov
* Bearbeidet IntArk arkitekturprinsipper og annen kildemateriale for å konkretisere føringer fra  https://www.digdir.no/digitalisering-og-samordning/overordnede-arkitekturprinsipper/1065[Overordnede
